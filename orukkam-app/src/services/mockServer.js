// Mock User Database
const USERS = [
    { username: 'student', password: '123', name: 'Midhun', role: 'student', avatar: 'boy', isNew: false },
    { username: 'newuser', password: '123', name: '', role: 'student', avatar: '', isNew: true },
    { username: 'teacher', password: 'admin', name: 'Reshmi Teacher', role: 'teacher', avatar: 'girl', isNew: false }
];
        ...
        return new Promise((resolve) => {
            setTimeout(() => {
                ...
                if (user) {
                    ...
                    resolve({ success: true, user: { name: user.name, role: user.role, avatar: user.avatar } });
                } else {
