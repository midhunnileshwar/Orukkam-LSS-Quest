    ...
    <div className="min-h-screen bg-candy-purple/10 flex flex-col p-6 overflow-y-auto">
      <div className="w-full flex justify-between items-center mb-8">
        <button
          ...
          className="p-3 bg-white rounded-full shadow-cartoon hover:scale-105 border-2 border-slate-100"
        >
      ...
      <div className="bg-white rounded-[2rem] p-8 shadow-cartoon-lg mb-8 border-4 border-white flex flex-col items-center relative overflow-hidden">
        ...
        <span className="text-slate-500 font-bold text-lg bg-slate-100 px-4 py-1 rounded-full">
          Class 4A • GHSS Taliparamba
        </span>
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        {avatarsList.map((avatarItem) => (
          ...
          >
            <div
              className={`w-16 h-16 rounded-2xl ${avatarItem.color} flex items-center justify-center text-4xl`}
            >
              {avatarItem.emoji}
            </div>
